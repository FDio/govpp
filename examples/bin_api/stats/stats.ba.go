...
func init() {
	api.RegisterMessage((*WantStats)(nil))
	api.RegisterMessage((*WantStatsReply)(nil))
	api.RegisterMessage((*WantInterfaceSimpleStats)(nil))
	api.RegisterMessage((*WantInterfaceSimpleStatsReply)(nil))
	api.RegisterMessage((*WantPerInterfaceSimpleStats)(nil))
	api.RegisterMessage((*WantPerInterfaceSimpleStatsReply)(nil))
	api.RegisterMessage((*WantInterfaceCombinedStats)(nil))
	api.RegisterMessage((*WantInterfaceCombinedStatsReply)(nil))
	api.RegisterMessage((*WantPerInterfaceCombinedStats)(nil))
	api.RegisterMessage((*WantPerInterfaceCombinedStatsReply)(nil))
	api.RegisterMessage((*WantIP4FibStats)(nil))
	api.RegisterMessage((*WantIP4FibStatsReply)(nil))
	api.RegisterMessage((*WantIP6FibStats)(nil))
	api.RegisterMessage((*WantIP6FibStatsReply)(nil))
	api.RegisterMessage((*WantIP4MfibStats)(nil))
	api.RegisterMessage((*WantIP4MfibStatsReply)(nil))
	api.RegisterMessage((*WantIP6MfibStats)(nil))
	api.RegisterMessage((*WantIP6MfibStatsReply)(nil))
	api.RegisterMessage((*WantIP4NbrStats)(nil))
	api.RegisterMessage((*WantIP4NbrStatsReply)(nil))
	api.RegisterMessage((*WantIP6NbrStats)(nil))
	api.RegisterMessage((*WantIP6NbrStatsReply)(nil))
	api.RegisterMessage((*VnetIP4FibCounters)(nil))
	api.RegisterMessage((*VnetIP4MfibCounters)(nil))
	api.RegisterMessage((*VnetIP4NbrCounters)(nil))
	api.RegisterMessage((*VnetIP6FibCounters)(nil))
	api.RegisterMessage((*VnetIP6MfibCounters)(nil))
	api.RegisterMessage((*VnetIP6NbrCounters)(nil))
	api.RegisterMessage((*VnetInterfaceSimpleCounters)(nil))
	api.RegisterMessage((*VnetInterfaceCombinedCounters)(nil))
	api.RegisterMessage((*VnetPerInterfaceSimpleCounters)(nil))
	api.RegisterMessage((*VnetPerInterfaceCombinedCounters)(nil))
	api.RegisterMessage((*VnetGetSummaryStats)(nil))
	api.RegisterMessage((*VnetGetSummaryStatsReply)(nil))
	api.RegisterMessage((*StatsGetPollerDelay)(nil))
	api.RegisterMessage((*StatsGetPollerDelayReply)(nil))
	api.RegisterMessage((*WantUDPEncapStats)(nil))
	api.RegisterMessage((*WantUDPEncapStatsReply)(nil))
	api.RegisterMessage((*VnetUDPEncapCounters)(nil))
}

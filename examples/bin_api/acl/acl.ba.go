...
func init() {
	api.RegisterMessage((*ACLPluginGetVersion)(nil))
	api.RegisterMessage((*ACLPluginGetVersionReply)(nil))
	api.RegisterMessage((*ACLPluginControlPing)(nil))
	api.RegisterMessage((*ACLPluginControlPingReply)(nil))
	api.RegisterMessage((*ACLAddReplace)(nil))
	api.RegisterMessage((*ACLAddReplaceReply)(nil))
	api.RegisterMessage((*ACLDel)(nil))
	api.RegisterMessage((*ACLDelReply)(nil))
	api.RegisterMessage((*ACLInterfaceAddDel)(nil))
	api.RegisterMessage((*ACLInterfaceAddDelReply)(nil))
	api.RegisterMessage((*ACLInterfaceSetACLList)(nil))
	api.RegisterMessage((*ACLInterfaceSetACLListReply)(nil))
	api.RegisterMessage((*ACLDump)(nil))
	api.RegisterMessage((*ACLDetails)(nil))
	api.RegisterMessage((*ACLInterfaceListDump)(nil))
	api.RegisterMessage((*ACLInterfaceListDetails)(nil))
	api.RegisterMessage((*MacipACLAdd)(nil))
	api.RegisterMessage((*MacipACLAddReply)(nil))
	api.RegisterMessage((*MacipACLAddReplace)(nil))
	api.RegisterMessage((*MacipACLAddReplaceReply)(nil))
	api.RegisterMessage((*MacipACLDel)(nil))
	api.RegisterMessage((*MacipACLDelReply)(nil))
	api.RegisterMessage((*MacipACLInterfaceAddDel)(nil))
	api.RegisterMessage((*MacipACLInterfaceAddDelReply)(nil))
	api.RegisterMessage((*MacipACLDump)(nil))
	api.RegisterMessage((*MacipACLDetails)(nil))
	api.RegisterMessage((*MacipACLInterfaceGet)(nil))
	api.RegisterMessage((*MacipACLInterfaceGetReply)(nil))
	api.RegisterMessage((*MacipACLInterfaceListDump)(nil))
	api.RegisterMessage((*MacipACLInterfaceListDetails)(nil))
	api.RegisterMessage((*ACLInterfaceSetEtypeWhitelist)(nil))
	api.RegisterMessage((*ACLInterfaceSetEtypeWhitelistReply)(nil))
	api.RegisterMessage((*ACLInterfaceEtypeWhitelistDump)(nil))
	api.RegisterMessage((*ACLInterfaceEtypeWhitelistDetails)(nil))
}

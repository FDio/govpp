...
// L2IntfFeatFlags defines enum 'l2_intf_feat_flags'.
type L2IntfFeatFlags uint32

const (
	L2_INTF_FEAT_NONE     L2IntfFeatFlags = 0
	L2_INTF_FEAT_LEARN    L2IntfFeatFlags = 1
	L2_INTF_FEAT_FWD      L2IntfFeatFlags = 2
	L2_INTF_FEAT_FLOOD    L2IntfFeatFlags = 4
	L2_INTF_FEAT_UU_FLOOD L2IntfFeatFlags = 8
	L2_INTF_FEAT_ARP_TERM L2IntfFeatFlags = 16
	L2_INTF_FEAT_ARP_UFWD L2IntfFeatFlags = 32
)

var (
	L2IntfFeatFlags_name = map[uint32]string{
		0:  "L2_INTF_FEAT_NONE",
		1:  "L2_INTF_FEAT_LEARN",
		2:  "L2_INTF_FEAT_FWD",
		4:  "L2_INTF_FEAT_FLOOD",
		8:  "L2_INTF_FEAT_UU_FLOOD",
		16: "L2_INTF_FEAT_ARP_TERM",
		32: "L2_INTF_FEAT_ARP_UFWD",
	}
	L2IntfFeatFlags_value = map[string]uint32{
		"L2_INTF_FEAT_NONE":     0,
...
func (x L2IntfFeatFlags) String() string {
	s, ok := L2IntfFeatFlags_name[uint32(x)]
	if ok {
		return s
	}
	str := func(n uint32) string {
		s, ok := L2IntfFeatFlags_name[uint32(n)]
		if ok {
			return s
		}
		return "L2IntfFeatFlags(" + strconv.Itoa(int(n)) + ")"
	}
	for i := uint32(0); i <= 32; i++ {
		val := uint32(x)
		if val&(1<<i) != 0 {
...
// Get interface L2 flags (companion getter for l2_flags)
//   - sw_if_index - interface to query
//
// L2FlagsGet defines message 'l2_flags_get'.
type L2FlagsGet struct {
	SwIfIndex interface_types.InterfaceIndex `binapi:"interface_index,name=sw_if_index" json:"sw_if_index,omitempty"`
}

func (m *L2FlagsGet) Reset()               { *m = L2FlagsGet{} }
func (*L2FlagsGet) GetMessageName() string { return "l2_flags_get" }
func (*L2FlagsGet) GetCrcString() string   { return "f9e6675e" }
func (*L2FlagsGet) GetMessageType() api.MessageType {
	return api.RequestMessage
}

func (m *L2FlagsGet) Size() (size int) {
	if m == nil {
		return 0
	}
	size += 4 // m.SwIfIndex
...
func (m *L2FlagsGet) Marshal(b []byte) ([]byte, error) {
	if b == nil {
		b = make([]byte, m.Size())
	}
	buf := codec.NewBuffer(b)
...
func (m *L2FlagsGet) Unmarshal(b []byte) error {
	buf := codec.NewBuffer(b)
	m.SwIfIndex = interface_types.InterfaceIndex(buf.DecodeUint32())
	return nil
}

// Get interface L2 flags response
//   - retval - return code
//   - input_feature_bitmap - raw internal L2 input feature bitmap for the interface
//   - output_feature_bitmap - raw internal L2 output feature bitmap for the interface
//
// L2FlagsGetReply defines message 'l2_flags_get_reply'.
type L2FlagsGetReply struct {
	Retval              int32  `binapi:"i32,name=retval" json:"retval,omitempty"`
	InputFeatureBitmap  uint32 `binapi:"u32,name=input_feature_bitmap" json:"input_feature_bitmap,omitempty"`
	OutputFeatureBitmap uint32 `binapi:"u32,name=output_feature_bitmap" json:"output_feature_bitmap,omitempty"`
}

func (m *L2FlagsGetReply) Reset()               { *m = L2FlagsGetReply{} }
func (*L2FlagsGetReply) GetMessageName() string { return "l2_flags_get_reply" }
func (*L2FlagsGetReply) GetCrcString() string   { return "35cb810f" }
func (*L2FlagsGetReply) GetMessageType() api.MessageType {
	return api.ReplyMessage
}

func (m *L2FlagsGetReply) Size() (size int) {
	if m == nil {
		return 0
	}
	size += 4 // m.Retval
	size += 4 // m.InputFeatureBitmap
	size += 4 // m.OutputFeatureBitmap
	return size
}
func (m *L2FlagsGetReply) Marshal(b []byte) ([]byte, error) {
	if b == nil {
		b = make([]byte, m.Size())
	}
	buf := codec.NewBuffer(b)
	buf.EncodeInt32(m.Retval)
	buf.EncodeUint32(m.InputFeatureBitmap)
	buf.EncodeUint32(m.OutputFeatureBitmap)
	return buf.Bytes(), nil
}
func (m *L2FlagsGetReply) Unmarshal(b []byte) error {
	buf := codec.NewBuffer(b)
	m.Retval = buf.DecodeInt32()
	m.InputFeatureBitmap = buf.DecodeUint32()
	m.OutputFeatureBitmap = buf.DecodeUint32()
	return nil
}
...
// Set interface L2 flags (upgraded companion setter for l2_flags_get).
//
//	Sets or clears raw feature bitmap bits on both the input and output paths.
//	Pass zero for a bitmap to leave that direction unchanged.
//	- sw_if_index - interface to modify
//	- is_set - if non-zero set the bits, else clear them
//	- input_feature_bitmap - input feature bits to set or clear
//	- output_feature_bitmap - output feature bits to set or clear
//
// L2FlagsSet defines message 'l2_flags_set'.
type L2FlagsSet struct {
	SwIfIndex           interface_types.InterfaceIndex `binapi:"interface_index,name=sw_if_index" json:"sw_if_index,omitempty"`
	IsSet               bool                           `binapi:"bool,name=is_set" json:"is_set,omitempty"`
	InputFeatureBitmap  uint32                         `binapi:"u32,name=input_feature_bitmap" json:"input_feature_bitmap,omitempty"`
	OutputFeatureBitmap uint32                         `binapi:"u32,name=output_feature_bitmap" json:"output_feature_bitmap,omitempty"`
...
func (m *L2FlagsSet) Reset()               { *m = L2FlagsSet{} }
func (*L2FlagsSet) GetMessageName() string { return "l2_flags_set" }
func (*L2FlagsSet) GetCrcString() string   { return "d4030647" }
func (*L2FlagsSet) GetMessageType() api.MessageType {
	return api.RequestMessage
}

func (m *L2FlagsSet) Size() (size int) {
	if m == nil {
		return 0
	}
	size += 4 // m.SwIfIndex
...
func (m *L2FlagsSet) Marshal(b []byte) ([]byte, error) {
	if b == nil {
		b = make([]byte, m.Size())
	}
	buf := codec.NewBuffer(b)
...
func (m *L2FlagsSet) Unmarshal(b []byte) error {
	buf := codec.NewBuffer(b)
	m.SwIfIndex = interface_types.InterfaceIndex(buf.DecodeUint32())
	m.IsSet = buf.DecodeBool()
	m.InputFeatureBitmap = buf.DecodeUint32()
...
// L2FlagsSetReply defines message 'l2_flags_set_reply'.
type L2FlagsSetReply struct {
	Retval int32 `binapi:"i32,name=retval" json:"retval,omitempty"`
}

func (m *L2FlagsSetReply) Reset()               { *m = L2FlagsSetReply{} }
func (*L2FlagsSetReply) GetMessageName() string { return "l2_flags_set_reply" }
func (*L2FlagsSetReply) GetCrcString() string   { return "e8d4e804" }
func (*L2FlagsSetReply) GetMessageType() api.MessageType {
	return api.ReplyMessage
}

func (m *L2FlagsSetReply) Size() (size int) {
	if m == nil {
		return 0
	}
	size += 4 // m.Retval
...
func (m *L2FlagsSetReply) Marshal(b []byte) ([]byte, error) {
	if b == nil {
		b = make([]byte, m.Size())
	}
	buf := codec.NewBuffer(b)
...
func (m *L2FlagsSetReply) Unmarshal(b []byte) error {
	buf := codec.NewBuffer(b)
	m.Retval = buf.DecodeInt32()
	return nil
}
...
// Get L2 per-interface feature flags
//   - sw_if_index - interface to query
//
// L2InterfaceFeatFlagsGet defines message 'l2_interface_feat_flags_get'.
type L2InterfaceFeatFlagsGet struct {
	SwIfIndex interface_types.InterfaceIndex `binapi:"interface_index,name=sw_if_index" json:"sw_if_index,omitempty"`
}

func (m *L2InterfaceFeatFlagsGet) Reset()               { *m = L2InterfaceFeatFlagsGet{} }
func (*L2InterfaceFeatFlagsGet) GetMessageName() string { return "l2_interface_feat_flags_get" }
func (*L2InterfaceFeatFlagsGet) GetCrcString() string   { return "f9e6675e" }
func (*L2InterfaceFeatFlagsGet) GetMessageType() api.MessageType {
	return api.RequestMessage
}

func (m *L2InterfaceFeatFlagsGet) Size() (size int) {
	if m == nil {
		return 0
	}
	size += 4 // m.SwIfIndex
...
func (m *L2InterfaceFeatFlagsGet) Marshal(b []byte) ([]byte, error) {
	if b == nil {
		b = make([]byte, m.Size())
	}
	buf := codec.NewBuffer(b)
...
func (m *L2InterfaceFeatFlagsGet) Unmarshal(b []byte) error {
	buf := codec.NewBuffer(b)
	m.SwIfIndex = interface_types.InterfaceIndex(buf.DecodeUint32())
	return nil
}

// Reply for l2_interface_feat_flags_get
//   - retval - return code
//   - flags - current feature flags active on this interface
//
// L2InterfaceFeatFlagsGetReply defines message 'l2_interface_feat_flags_get_reply'.
type L2InterfaceFeatFlagsGetReply struct {
	Retval int32           `binapi:"i32,name=retval" json:"retval,omitempty"`
	Flags  L2IntfFeatFlags `binapi:"l2_intf_feat_flags,name=flags" json:"flags,omitempty"`
}

func (m *L2InterfaceFeatFlagsGetReply) Reset() { *m = L2InterfaceFeatFlagsGetReply{} }
func (*L2InterfaceFeatFlagsGetReply) GetMessageName() string {
	return "l2_interface_feat_flags_get_reply"
}
func (*L2InterfaceFeatFlagsGetReply) GetCrcString() string { return "a4149215" }
func (*L2InterfaceFeatFlagsGetReply) GetMessageType() api.MessageType {
	return api.ReplyMessage
}

func (m *L2InterfaceFeatFlagsGetReply) Size() (size int) {
	if m == nil {
		return 0
	}
	size += 4 // m.Retval
...
func (m *L2InterfaceFeatFlagsGetReply) Marshal(b []byte) ([]byte, error) {
	if b == nil {
		b = make([]byte, m.Size())
	}
	buf := codec.NewBuffer(b)
...
func (m *L2InterfaceFeatFlagsGetReply) Unmarshal(b []byte) error {
	buf := codec.NewBuffer(b)
	m.Retval = buf.DecodeInt32()
	m.Flags = L2IntfFeatFlags(buf.DecodeUint32())
	return nil
}

// Set or clear L2 per-interface feature flags
//   - sw_if_index - interface to modify
//   - is_set - true to enable the given flags, false to disable them
//   - flags - which feature flags to enable or disable
//
// L2InterfaceFeatFlagsSet defines message 'l2_interface_feat_flags_set'.
type L2InterfaceFeatFlagsSet struct {
	SwIfIndex interface_types.InterfaceIndex `binapi:"interface_index,name=sw_if_index" json:"sw_if_index,omitempty"`
	IsSet     bool                           `binapi:"bool,name=is_set" json:"is_set,omitempty"`
	Flags     L2IntfFeatFlags                `binapi:"l2_intf_feat_flags,name=flags" json:"flags,omitempty"`
}

func (m *L2InterfaceFeatFlagsSet) Reset()               { *m = L2InterfaceFeatFlagsSet{} }
func (*L2InterfaceFeatFlagsSet) GetMessageName() string { return "l2_interface_feat_flags_set" }
func (*L2InterfaceFeatFlagsSet) GetCrcString() string   { return "c4e2865c" }
func (*L2InterfaceFeatFlagsSet) GetMessageType() api.MessageType {
	return api.RequestMessage
}

func (m *L2InterfaceFeatFlagsSet) Size() (size int) {
	if m == nil {
		return 0
	}
	size += 4 // m.SwIfIndex
...
func (m *L2InterfaceFeatFlagsSet) Marshal(b []byte) ([]byte, error) {
	if b == nil {
		b = make([]byte, m.Size())
	}
	buf := codec.NewBuffer(b)
...
func (m *L2InterfaceFeatFlagsSet) Unmarshal(b []byte) error {
	buf := codec.NewBuffer(b)
	m.SwIfIndex = interface_types.InterfaceIndex(buf.DecodeUint32())
	m.IsSet = buf.DecodeBool()
	m.Flags = L2IntfFeatFlags(buf.DecodeUint32())
...
// L2InterfaceFeatFlagsSetReply defines message 'l2_interface_feat_flags_set_reply'.
type L2InterfaceFeatFlagsSetReply struct {
	Retval int32 `binapi:"i32,name=retval" json:"retval,omitempty"`
}

func (m *L2InterfaceFeatFlagsSetReply) Reset() { *m = L2InterfaceFeatFlagsSetReply{} }
func (*L2InterfaceFeatFlagsSetReply) GetMessageName() string {
	return "l2_interface_feat_flags_set_reply"
}
func (*L2InterfaceFeatFlagsSetReply) GetCrcString() string { return "e8d4e804" }
func (*L2InterfaceFeatFlagsSetReply) GetMessageType() api.MessageType {
	return api.ReplyMessage
}

func (m *L2InterfaceFeatFlagsSetReply) Size() (size int) {
	if m == nil {
		return 0
	}
	size += 4 // m.Retval
...
func (m *L2InterfaceFeatFlagsSetReply) Marshal(b []byte) ([]byte, error) {
	if b == nil {
		b = make([]byte, m.Size())
	}
	buf := codec.NewBuffer(b)
...
func (m *L2InterfaceFeatFlagsSetReply) Unmarshal(b []byte) error {
	buf := codec.NewBuffer(b)
	m.Retval = buf.DecodeInt32()
	return nil
}
...
func file_l2_binapi_init() {
	...
	api.RegisterMessage((*L2FlagsGet)(nil), "l2_flags_get_f9e6675e")
	api.RegisterMessage((*L2FlagsGetReply)(nil), "l2_flags_get_reply_35cb810f")
	api.RegisterMessage((*L2FlagsReply)(nil), "l2_flags_reply_29b2a2b3")
	api.RegisterMessage((*L2FlagsSet)(nil), "l2_flags_set_d4030647")
	api.RegisterMessage((*L2FlagsSetReply)(nil), "l2_flags_set_reply_e8d4e804")
	...
	api.RegisterMessage((*L2InterfaceFeatFlagsGet)(nil), "l2_interface_feat_flags_get_f9e6675e")
	api.RegisterMessage((*L2InterfaceFeatFlagsGetReply)(nil), "l2_interface_feat_flags_get_reply_a4149215")
	api.RegisterMessage((*L2InterfaceFeatFlagsSet)(nil), "l2_interface_feat_flags_set_c4e2865c")
	api.RegisterMessage((*L2InterfaceFeatFlagsSetReply)(nil), "l2_interface_feat_flags_set_reply_e8d4e804")
...
func AllMessages() []api.Message {
	return []api.Message{
		...
		(*L2InterfaceFeatFlagsGet)(nil),
		(*L2InterfaceFeatFlagsGetReply)(nil),
		(*L2InterfaceFeatFlagsSet)(nil),
		(*L2InterfaceFeatFlagsSetReply)(nil),

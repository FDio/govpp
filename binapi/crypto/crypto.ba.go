...
func (m *CryptoSetAsyncDispatchV2) Reset()               { *m = CryptoSetAsyncDispatchV2{} }
func (*CryptoSetAsyncDispatchV2) GetMessageName() string { return "crypto_set_async_dispatch_v2" }
func (*CryptoSetAsyncDispatchV2) GetCrcString() string   { return "667d2d54" }
...
func (m *CryptoSetAsyncDispatchV2Reply) Reset() { *m = CryptoSetAsyncDispatchV2Reply{} }
func (*CryptoSetAsyncDispatchV2Reply) GetMessageName() string {
	return "crypto_set_async_dispatch_v2_reply"
}
func (*CryptoSetAsyncDispatchV2Reply) GetCrcString() string { return "e8d4e804" }
...
func file_crypto_binapi_init() {
	...
	api.RegisterMessage((*CryptoSetAsyncDispatchV2)(nil), "crypto_set_async_dispatch_v2_667d2d54")
	api.RegisterMessage((*CryptoSetAsyncDispatchV2Reply)(nil), "crypto_set_async_dispatch_v2_reply_e8d4e804")
...
func AllMessages() []api.Message {
	return []api.Message{
		...
		(*CryptoSetAsyncDispatchV2)(nil),
		(*CryptoSetAsyncDispatchV2Reply)(nil),

...
// Enable passthrough for a given OSI protocol
//   - osi_proto - the OSI protocol to enable
//
// LcpOsiProtoEnable defines message 'lcp_osi_proto_enable'.
type LcpOsiProtoEnable struct {
	OsiProto uint8 `binapi:"u8,name=osi_proto" json:"osi_proto,omitempty"`
}

func (m *LcpOsiProtoEnable) Reset()               { *m = LcpOsiProtoEnable{} }
func (*LcpOsiProtoEnable) GetMessageName() string { return "lcp_osi_proto_enable" }
func (*LcpOsiProtoEnable) GetCrcString() string   { return "bdd70c87" }
func (*LcpOsiProtoEnable) GetMessageType() api.MessageType {
	return api.RequestMessage
}

func (m *LcpOsiProtoEnable) Size() (size int) {
	if m == nil {
		return 0
	}
	size += 1 // m.OsiProto
...
func (m *LcpOsiProtoEnable) Marshal(b []byte) ([]byte, error) {
	if b == nil {
		b = make([]byte, m.Size())
	}
	buf := codec.NewBuffer(b)
	buf.EncodeUint8(m.OsiProto)
	return buf.Bytes(), nil
}
func (m *LcpOsiProtoEnable) Unmarshal(b []byte) error {
	buf := codec.NewBuffer(b)
	m.OsiProto = buf.DecodeUint8()
	return nil
}

// LcpOsiProtoEnableReply defines message 'lcp_osi_proto_enable_reply'.
type LcpOsiProtoEnableReply struct {
	Retval int32 `binapi:"i32,name=retval" json:"retval,omitempty"`
}

func (m *LcpOsiProtoEnableReply) Reset()               { *m = LcpOsiProtoEnableReply{} }
func (*LcpOsiProtoEnableReply) GetMessageName() string { return "lcp_osi_proto_enable_reply" }
func (*LcpOsiProtoEnableReply) GetCrcString() string   { return "e8d4e804" }
func (*LcpOsiProtoEnableReply) GetMessageType() api.MessageType {
	return api.ReplyMessage
}

func (m *LcpOsiProtoEnableReply) Size() (size int) {
	if m == nil {
		return 0
	}
	size += 4 // m.Retval
...
func (m *LcpOsiProtoEnableReply) Marshal(b []byte) ([]byte, error) {
	if b == nil {
		b = make([]byte, m.Size())
	}
	buf := codec.NewBuffer(b)
...
func (m *LcpOsiProtoEnableReply) Unmarshal(b []byte) error {
	buf := codec.NewBuffer(b)
	m.Retval = buf.DecodeInt32()
	return nil
}

// Get the enabled OSI protocols for passthrough
// LcpOsiProtoGet defines message 'lcp_osi_proto_get'.
type LcpOsiProtoGet struct{}

func (m *LcpOsiProtoGet) Reset()               { *m = LcpOsiProtoGet{} }
func (*LcpOsiProtoGet) GetMessageName() string { return "lcp_osi_proto_get" }
func (*LcpOsiProtoGet) GetCrcString() string   { return "51077d14" }
func (*LcpOsiProtoGet) GetMessageType() api.MessageType {
	return api.RequestMessage
}

func (m *LcpOsiProtoGet) Size() (size int) {
	if m == nil {
		return 0
	}
	return size
}
func (m *LcpOsiProtoGet) Marshal(b []byte) ([]byte, error) {
	if b == nil {
		b = make([]byte, m.Size())
	}
	buf := codec.NewBuffer(b)
...
func (m *LcpOsiProtoGet) Unmarshal(b []byte) error {
	return nil
}

// Reply to get the enabled OSI protocols for passthrough
//   - retval - return code for the request
//   - count - number of enabled OSI protocols
//   - osi_protos - array of enabled OSI protocols
//
// LcpOsiProtoGetReply defines message 'lcp_osi_proto_get_reply'.
type LcpOsiProtoGetReply struct {
	Retval    int32  `binapi:"i32,name=retval" json:"retval,omitempty"`
	Count     uint8  `binapi:"u8,name=count" json:"-"`
	OsiProtos []byte `binapi:"u8[count],name=osi_protos" json:"osi_protos,omitempty"`
}

func (m *LcpOsiProtoGetReply) Reset()               { *m = LcpOsiProtoGetReply{} }
func (*LcpOsiProtoGetReply) GetMessageName() string { return "lcp_osi_proto_get_reply" }
func (*LcpOsiProtoGetReply) GetCrcString() string   { return "3b19a287" }
func (*LcpOsiProtoGetReply) GetMessageType() api.MessageType {
	return api.ReplyMessage
}

func (m *LcpOsiProtoGetReply) Size() (size int) {
	if m == nil {
		return 0
	}
	size += 4                    // m.Retval
	size += 1                    // m.Count
	size += 1 * len(m.OsiProtos) // m.OsiProtos
	return size
}
func (m *LcpOsiProtoGetReply) Marshal(b []byte) ([]byte, error) {
	if b == nil {
		b = make([]byte, m.Size())
	}
	buf := codec.NewBuffer(b)
	buf.EncodeInt32(m.Retval)
	buf.EncodeUint8(uint8(len(m.OsiProtos)))
	buf.EncodeBytes(m.OsiProtos, 0)
	return buf.Bytes(), nil
}
func (m *LcpOsiProtoGetReply) Unmarshal(b []byte) error {
	buf := codec.NewBuffer(b)
	m.Retval = buf.DecodeInt32()
	m.Count = buf.DecodeUint8()
	m.OsiProtos = make([]byte, m.Count)
	copy(m.OsiProtos, buf.DecodeBytes(len(m.OsiProtos)))
	return nil
}

// Get the sync-unnumbered setting
// LcpSyncUnnumberedGet defines message 'lcp_sync_unnumbered_get'.
type LcpSyncUnnumberedGet struct{}

func (m *LcpSyncUnnumberedGet) Reset()               { *m = LcpSyncUnnumberedGet{} }
func (*LcpSyncUnnumberedGet) GetMessageName() string { return "lcp_sync_unnumbered_get" }
func (*LcpSyncUnnumberedGet) GetCrcString() string   { return "51077d14" }
func (*LcpSyncUnnumberedGet) GetMessageType() api.MessageType {
	return api.RequestMessage
}

func (m *LcpSyncUnnumberedGet) Size() (size int) {
	if m == nil {
		return 0
	}
	return size
}
func (m *LcpSyncUnnumberedGet) Marshal(b []byte) ([]byte, error) {
	if b == nil {
		b = make([]byte, m.Size())
	}
	buf := codec.NewBuffer(b)
...
func (m *LcpSyncUnnumberedGet) Unmarshal(b []byte) error {
	return nil
}

// Reply to get the sync-unnumbered setting
//   - retval - return code for the request
//   - is_enable - true if sync-unnumbered is enabled
//
// LcpSyncUnnumberedGetReply defines message 'lcp_sync_unnumbered_get_reply'.
type LcpSyncUnnumberedGetReply struct {
	Retval   int32 `binapi:"i32,name=retval" json:"retval,omitempty"`
	IsEnable bool  `binapi:"bool,name=is_enable" json:"is_enable,omitempty"`
}

func (m *LcpSyncUnnumberedGetReply) Reset()               { *m = LcpSyncUnnumberedGetReply{} }
func (*LcpSyncUnnumberedGetReply) GetMessageName() string { return "lcp_sync_unnumbered_get_reply" }
func (*LcpSyncUnnumberedGetReply) GetCrcString() string   { return "f15abb16" }
func (*LcpSyncUnnumberedGetReply) GetMessageType() api.MessageType {
	return api.ReplyMessage
}

func (m *LcpSyncUnnumberedGetReply) Size() (size int) {
	if m == nil {
		return 0
	}
	size += 4 // m.Retval
...
func (m *LcpSyncUnnumberedGetReply) Marshal(b []byte) ([]byte, error) {
	if b == nil {
		b = make([]byte, m.Size())
	}
	buf := codec.NewBuffer(b)
...
func (m *LcpSyncUnnumberedGetReply) Unmarshal(b []byte) error {
	buf := codec.NewBuffer(b)
	m.Retval = buf.DecodeInt32()
...
// Enable or disable syncing unnumbered interface addresses to Linux
//   - is_enable - true to enable, false to disable
//
// LcpSyncUnnumberedSet defines message 'lcp_sync_unnumbered_set'.
type LcpSyncUnnumberedSet struct {
	IsEnable bool `binapi:"bool,name=is_enable" json:"is_enable,omitempty"`
}

func (m *LcpSyncUnnumberedSet) Reset()               { *m = LcpSyncUnnumberedSet{} }
func (*LcpSyncUnnumberedSet) GetMessageName() string { return "lcp_sync_unnumbered_set" }
func (*LcpSyncUnnumberedSet) GetCrcString() string   { return "c264d7bf" }
func (*LcpSyncUnnumberedSet) GetMessageType() api.MessageType {
	return api.RequestMessage
}

func (m *LcpSyncUnnumberedSet) Size() (size int) {
	if m == nil {
		return 0
	}
	size += 1 // m.IsEnable
...
func (m *LcpSyncUnnumberedSet) Marshal(b []byte) ([]byte, error) {
	if b == nil {
		b = make([]byte, m.Size())
	}
	buf := codec.NewBuffer(b)
...
func (m *LcpSyncUnnumberedSet) Unmarshal(b []byte) error {
	buf := codec.NewBuffer(b)
	m.IsEnable = buf.DecodeBool()
	return nil
}

// LcpSyncUnnumberedSetReply defines message 'lcp_sync_unnumbered_set_reply'.
type LcpSyncUnnumberedSetReply struct {
	Retval int32 `binapi:"i32,name=retval" json:"retval,omitempty"`
}

func (m *LcpSyncUnnumberedSetReply) Reset()               { *m = LcpSyncUnnumberedSetReply{} }
func (*LcpSyncUnnumberedSetReply) GetMessageName() string { return "lcp_sync_unnumbered_set_reply" }
func (*LcpSyncUnnumberedSetReply) GetCrcString() string   { return "e8d4e804" }
func (*LcpSyncUnnumberedSetReply) GetMessageType() api.MessageType {
	return api.ReplyMessage
}

func (m *LcpSyncUnnumberedSetReply) Size() (size int) {
	if m == nil {
		return 0
	}
	size += 4 // m.Retval
...
func (m *LcpSyncUnnumberedSetReply) Marshal(b []byte) ([]byte, error) {
	if b == nil {
		b = make([]byte, m.Size())
	}
	buf := codec.NewBuffer(b)
...
func (m *LcpSyncUnnumberedSetReply) Unmarshal(b []byte) error {
	buf := codec.NewBuffer(b)
	m.Retval = buf.DecodeInt32()
	return nil
}
...
func file_lcp_binapi_init() {
	...
	api.RegisterMessage((*LcpOsiProtoEnable)(nil), "lcp_osi_proto_enable_bdd70c87")
	api.RegisterMessage((*LcpOsiProtoEnableReply)(nil), "lcp_osi_proto_enable_reply_e8d4e804")
	api.RegisterMessage((*LcpOsiProtoGet)(nil), "lcp_osi_proto_get_51077d14")
	api.RegisterMessage((*LcpOsiProtoGetReply)(nil), "lcp_osi_proto_get_reply_3b19a287")
	api.RegisterMessage((*LcpSyncUnnumberedGet)(nil), "lcp_sync_unnumbered_get_51077d14")
	api.RegisterMessage((*LcpSyncUnnumberedGetReply)(nil), "lcp_sync_unnumbered_get_reply_f15abb16")
	api.RegisterMessage((*LcpSyncUnnumberedSet)(nil), "lcp_sync_unnumbered_set_c264d7bf")
	api.RegisterMessage((*LcpSyncUnnumberedSetReply)(nil), "lcp_sync_unnumbered_set_reply_e8d4e804")
}
...
func AllMessages() []api.Message {
	return []api.Message{
		...
		(*LcpOsiProtoEnable)(nil),
		(*LcpOsiProtoEnableReply)(nil),
		(*LcpOsiProtoGet)(nil),
		(*LcpOsiProtoGetReply)(nil),
		(*LcpSyncUnnumberedGet)(nil),
		(*LcpSyncUnnumberedGetReply)(nil),
		(*LcpSyncUnnumberedSet)(nil),
		(*LcpSyncUnnumberedSetReply)(nil),
	}
}

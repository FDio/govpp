...
//   - renumber - if true, use custom_dev_instance is valid
//   - custom_dev_instance - custom device instance number
//   - full_tx_queue_placement - perform tx placement for all queues on this interface
//
// CreateVhostUserIfV3 defines message 'create_vhost_user_if_v3'.
type CreateVhostUserIfV3 struct {
	IsServer             bool                      `binapi:"bool,name=is_server" json:"is_server,omitempty"`
	SockFilename         string                    `binapi:"string[256],name=sock_filename" json:"sock_filename,omitempty"`
	Renumber             bool                      `binapi:"bool,name=renumber" json:"renumber,omitempty"`
	DisableMrgRxbuf      bool                      `binapi:"bool,name=disable_mrg_rxbuf" json:"disable_mrg_rxbuf,omitempty"`
	...
	CustomDevInstance    uint32                    `binapi:"u32,name=custom_dev_instance" json:"custom_dev_instance,omitempty"`
	UseCustomMac         bool                      `binapi:"bool,name=use_custom_mac" json:"use_custom_mac,omitempty"`
	FullTxQueuePlacement bool                      `binapi:"bool,name=full_tx_queue_placement" json:"full_tx_queue_placement,omitempty"`
	MacAddress           ethernet_types.MacAddress `binapi:"mac_address,name=mac_address" json:"mac_address,omitempty"`
	Tag                  string                    `binapi:"string[64],name=tag" json:"tag,omitempty"`
}

func (m *CreateVhostUserIfV3) Reset()               { *m = CreateVhostUserIfV3{} }
func (*CreateVhostUserIfV3) GetMessageName() string { return "create_vhost_user_if_v3" }
func (*CreateVhostUserIfV3) GetCrcString() string   { return "49c2a778" }
func (*CreateVhostUserIfV3) GetMessageType() api.MessageType {
	return api.RequestMessage
}

func (m *CreateVhostUserIfV3) Size() (size int) {
	if m == nil {
		return 0
	}
	size += 1     // m.IsServer
	...
	size += 4     // m.CustomDevInstance
	size += 1     // m.UseCustomMac
	size += 1     // m.FullTxQueuePlacement
	size += 1 * 6 // m.MacAddress
	size += 64    // m.Tag
	return size
}
func (m *CreateVhostUserIfV3) Marshal(b []byte) ([]byte, error) {
	if b == nil {
		b = make([]byte, m.Size())
	}
	buf := codec.NewBuffer(b)
	...
	buf.EncodeUint32(m.CustomDevInstance)
	buf.EncodeBool(m.UseCustomMac)
	buf.EncodeBool(m.FullTxQueuePlacement)
	buf.EncodeBytes(m.MacAddress[:], 6)
	buf.EncodeString(m.Tag, 64)
	return buf.Bytes(), nil
}
func (m *CreateVhostUserIfV3) Unmarshal(b []byte) error {
	buf := codec.NewBuffer(b)
	m.IsServer = buf.DecodeBool()
	m.SockFilename = buf.DecodeString(256)
	m.Renumber = buf.DecodeBool()
	...
	m.CustomDevInstance = buf.DecodeUint32()
	m.UseCustomMac = buf.DecodeBool()
	m.FullTxQueuePlacement = buf.DecodeBool()
	copy(m.MacAddress[:], buf.DecodeBytes(6))
	m.Tag = buf.DecodeString(64)
	return nil
}
...
//   - sw_if_index - interface the operation is applied to
//
// CreateVhostUserIfV3Reply defines message 'create_vhost_user_if_v3_reply'.
type CreateVhostUserIfV3Reply struct {
	Retval    int32                          `binapi:"i32,name=retval" json:"retval,omitempty"`
	SwIfIndex interface_types.InterfaceIndex `binapi:"interface_index,name=sw_if_index" json:"sw_if_index,omitempty"`
}

func (m *CreateVhostUserIfV3Reply) Reset()               { *m = CreateVhostUserIfV3Reply{} }
func (*CreateVhostUserIfV3Reply) GetMessageName() string { return "create_vhost_user_if_v3_reply" }
func (*CreateVhostUserIfV3Reply) GetCrcString() string   { return "5383d31f" }
func (*CreateVhostUserIfV3Reply) GetMessageType() api.MessageType {
	return api.ReplyMessage
}

func (m *CreateVhostUserIfV3Reply) Size() (size int) {
	if m == nil {
		return 0
	}
	size += 4 // m.Retval
...
func (m *CreateVhostUserIfV3Reply) Marshal(b []byte) ([]byte, error) {
	if b == nil {
		b = make([]byte, m.Size())
	}
	buf := codec.NewBuffer(b)
...
func (m *CreateVhostUserIfV3Reply) Unmarshal(b []byte) error {
	buf := codec.NewBuffer(b)
	m.Retval = buf.DecodeInt32()
	m.SwIfIndex = interface_types.InterfaceIndex(buf.DecodeUint32())
	return nil
...
func file_vhost_user_binapi_init() {
	...
	api.RegisterMessage((*CreateVhostUserIfV3)(nil), "create_vhost_user_if_v3_49c2a778")
	api.RegisterMessage((*CreateVhostUserIfV3Reply)(nil), "create_vhost_user_if_v3_reply_5383d31f")
...
func AllMessages() []api.Message {
	return []api.Message{
		...
		(*CreateVhostUserIfV3)(nil),
		(*CreateVhostUserIfV3Reply)(nil),

...
func (*GreTunnelV2Details) GetCrcString() string   { return "65521177" }
...
// GreTunnelV2DumpReply defines message 'gre_tunnel_v2_dump_reply'.
type GreTunnelV2DumpReply struct {
	Retval int32 `binapi:"i32,name=retval" json:"retval,omitempty"`
}

func (m *GreTunnelV2DumpReply) Reset()               { *m = GreTunnelV2DumpReply{} }
func (*GreTunnelV2DumpReply) GetMessageName() string { return "gre_tunnel_v2_dump_reply" }
func (*GreTunnelV2DumpReply) GetCrcString() string   { return "e8d4e804" }
func (*GreTunnelV2DumpReply) GetMessageType() api.MessageType {
	return api.ReplyMessage
}

func (m *GreTunnelV2DumpReply) Size() (size int) {
	if m == nil {
		return 0
	}
	size += 4 // m.Retval
...
func (m *GreTunnelV2DumpReply) Marshal(b []byte) ([]byte, error) {
	if b == nil {
		b = make([]byte, m.Size())
	}
	buf := codec.NewBuffer(b)
...
func (m *GreTunnelV2DumpReply) Unmarshal(b []byte) error {
	buf := codec.NewBuffer(b)
	m.Retval = buf.DecodeInt32()
	return nil
}
...
func file_gre_binapi_init() {
	...
	api.RegisterMessage((*GreTunnelV2Details)(nil), "gre_tunnel_v2_details_65521177")
	api.RegisterMessage((*GreTunnelV2Dump)(nil), "gre_tunnel_v2_dump_f9e6675e")
	api.RegisterMessage((*GreTunnelV2DumpReply)(nil), "gre_tunnel_v2_dump_reply_e8d4e804")
}

...
const (
	// RequestMessageType represents a VPP request message
	RequestMessageType MessageType = iota
	// ReplyMessageType represents a VPP reply message
	ReplyMessageType
	// EventMessageType represents a VPP event message
	EventMessageType
	// OtherMessageType represents other VPP message
	OtherMessageType
)

...
func GenerateVersion(gen *Generator, file *File) *GenFile {
	logf("----------------------------")
	logf(" Generate Version - %s", file.Desc.Name)
	logf("----------------------------")

	filename := path.Join(file.FilenamePrefix, file.Desc.Name+".version.go")
